						...
						<h1 className='absolute text-white ml-20 mt-4'>Username</h1>
							<div className='absolute flex flex-col gap-8 ml-4 mt-36 text-black'>
								...
								<button className='flex flex-row gap-2 cursor-pointer shadow-xl shadow-[#009c00] hover:text-white hover:border-2 hover:rounded-full p-4 hover:shadow-black text-4xl ' onClick={handleMessage}  ><FaComments/>Messages</button> 
									...
									<div>
						<button className='flex flex-row gap-2 cursor-pointer shadow-xl shadow-[#009c00] hover:text-white hover:border-2 hover:rounded-full p-4 hover:shadow-black text-4xl ' onClick={handleFav1}   ><FaHeart/>Favourites</button>
       	 				</div>
								<div>
		<button className='flex flex-row gap-2 cursor-pointer shadow-xl text-white border-2 rounded-full p-4 shadow-black text-4xl ' onClick={handleSet}  ><FaGear/>Settings</button>       	 				</div>
								<button className='flex flex-row gap-2 cursor-pointer shadow-xl shadow-[#009c00] hover:text-white hover:border-2 hover:rounded-full p-4 hover:shadow-black text-4xl ' onClick={handlelog} ><FaArrowRightToBracket/>Logout</button>
							</div>
